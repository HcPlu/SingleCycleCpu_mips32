...
always @* begin  // 6种移位指令
       if(Sftmd)
        ...
        //Ainput是干什么的？，binput=readdata2
            ...
            3'b111:Sinput = $signed(Binput)>>>Ainput;		        //Srav rd,rt,rs 00111，注意算术???????????
    ...
    always @* begin
        if(((ALU_ctl==3'b111) && (Exe_code[3]==1))||((ALU_ctl[2:1]==2'b11) && (I_format==1))) //slti(sub)  处理所有SLT类的问题
         begin   ALU_Result =  (ALU_output_mux[31]==1?1'b1:1'b0) ;

          end
        else if((ALU_ctl==3'b101) && (I_format==1)) ALU_Result[31:0] = {Binput[16:0],16'h0000};   //lui data
    ...
    always @(ALU_ctl or Ainput or Binput) begin
        case(ALU_ctl)
            ...
            3'b101:ALU_output_mux =~(Ainput|Binput);//没有必要吗？？
